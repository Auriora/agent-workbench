...
| Agent IDE replacement analysis delivery record | [Agent IDE capability analysis requirements](../specs/010-agent-ide-capability-analysis/requirements.md) | Archived Spec 010 delivery evidence. Current replacement capability analysis lives in the durable matrix below; high-priority follow-up work is active in Specs 011 and 012. |
...
| Active FTS-backed docs search work | [FTS-backed docs search requirements](../specs/013-fts-backed-docs-search/requirements.md) | Active implementation spec for replacing scanner-backed `docs_search` with SQLite FTS-backed docs indexing, ranking, pagination, freshness, and parity evidence. |
