...
| MCP server repository support delivery record | [MCP server repository support requirements](../specs/022-mcp-server-repository-support/requirements.md) | Spec 022 completion evidence. Current MCP-server repo-shape detection, context routing, and safe validation-planning behavior lives in [MCP surface design](../design/mcp-surface-design.md) and [Coding agent integration design](../design/coding-agent-integration-design.md). |
