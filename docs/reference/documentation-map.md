...
| Active doc currency routing spec | [Spec 034](../specs/034-doc-currency-routing/requirements.md) | Active implementation package for task-focused documentation currency, stale-doc routing, optional Git recency evidence, no-`ctime` policy, and spec-lifecycle-manager feedback. |
