...
| 4 | Ruby/Rails | current `partial_semantic` | Specs 047 and 048 deliver catalog/project-shape/context/validation planning plus one `tree-sitter-ruby` path for declarations, bounded references, conservative impact and static Rails route/model/concern DSL records; runtime dispatch and metaprogramming remain deferred |
