...
the `.tgz` from that page and `npm install -g ./auriora-agent-workbench-0.4.0.tgz`.
...
claude plugin list   # -> agent-workbench@agent-workbench-local  v0.4.0  enabled
```
...
codex plugin list   # -> agent-workbench@agent-workbench-local  v0.4.0  installed, enabled
```
