...
claude plugin list   # -> agent-workbench@agent-workbench-local  v0.6.4  enabled
```
...
codex plugin list   # -> agent-workbench@agent-workbench-local  v0.6.4  installed, enabled
```
