...
| Requirement 5: Large-Repo Regression Must Be Fixture-Backed | must-have | AC1, AC2, AC3 | Validation Strategy; Downstream Task Guidance | T002, T003, T008 | Fixture-backed Vitest tests | MVP proof matrix if needed | partial-blocking | T004/T005/T007 implementation remains required. |
...
| CP-003 | Requirements 2, 5 | Algorithms and Logic; Data Flow | T002, T004, T008 | Phase 1 characterization test plus Phase 2 passing behavior tests | High until implemented. |
