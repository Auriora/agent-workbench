...
Spec 031 implementation is complete and ready for closure review. Accepted
behavior is already promoted to `docs/reference/workspace-safety-contract.md`
and `docs/security/threat-model.md`; EB033 keeps broader generated-file
source-of-truth inference outside this spec.
