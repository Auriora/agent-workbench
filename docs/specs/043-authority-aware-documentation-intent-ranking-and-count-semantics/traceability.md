...
| Requirement 3 | must-have | AC3.1, AC3.2, AC3.3, AC3.4, AC3.5, AC3.6 | Complete Frozen Pagination | T001-T002, T005, T007-T010 | V001, V004-V005, V008-V019 | MCP surface design; runtime contracts | not-covered | active Spec 043 |
...
| T003 | Requirement 1, Requirement 2 | AC1.1, AC1.9, AC2.1, AC2.6 | Concern Ownership Index; Schema, Migration, And Publication | graph schema and publication | V002, V006 | graph store design; documentation map | none |
...
| T006 | Requirement 2, Requirement 4 | AC2.1, AC2.6, AC4.1, AC4.2, AC4.3, AC4.4, AC4.5, AC4.6, AC4.7, AC4.8 | Count And Filter Receipt; Failure And Trust Behavior | presentation and public envelope | V001, V004, V006 | runtime contracts | none |
...
| T003 | extraction/schema/index/publication | Requirements 1, 2; AC1.1, AC1.2, AC1.3, AC1.4, AC1.5, AC1.8, AC1.9, AC2.1, AC2.2, AC2.3, AC2.4, AC2.5, AC2.6; CP-002, CP-003, CP-008 | `tests/graph/documentation-map-indexing.test.ts`; `tests/graph/documentation-owner-publication.test.ts` | graph store design; documentation map |
...
| T006 | presentation/counts/trust | Requirements 2, 4; AC2.1, AC2.2, AC2.3, AC2.4, AC2.6, AC4.1, AC4.2, AC4.3, AC4.4, AC4.5, AC4.6, AC4.7, AC4.8; CP-002, CP-006, CP-007, CP-008 | `tests/presentation/docs-ranking-presenter.test.ts`; `tests/mcp/docs-ranking-tool.test.ts` | runtime contracts |
