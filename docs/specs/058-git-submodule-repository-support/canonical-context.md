...
| `canonical-context.md` | `docs/design/edit-and-validation-loop-design.md`, `docs/reference/runtime-contracts.md`, and `docs/history/spec-closure-log.md` | Spec 057 closure reviewed 2026-08-04 | adapted | Closed Spec 057 delivered project-unit discovery, validation isolation, and non-traversed repository boundaries. Spec 058 supersedes only the initialized-submodule residual. | Current validation design and runtime contracts |
