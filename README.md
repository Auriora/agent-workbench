...
With `nvm` installed, install Node.js 22 and the v0.6.7 runtime:
...
```bash
CXXFLAGS="-std=c++20" npm install -g https://github.com/Auriora/agent-workbench/releases/download/v0.6.7/auriora-agent-workbench-0.6.7.tgz
```
...
```bash
npm install -g ./auriora-agent-workbench-0.6.7.tgz
```
...
node --version
npm.cmd --version
npm.cmd install --global "https://github.com/Auriora/agent-workbench/releases/download/v0.6.7/auriora-agent-workbench-0.6.7.tgz"
```
...
```powershell
npm.cmd install --global ".\auriora-agent-workbench-0.6.7.tgz"
```
