...
```bash
npm install -g ./auriora-agent-workbench-0.5.1.tgz
```

If you must install under Node 24, pass C++20 flags to the native build:

```bash
CXXFLAGS="-std=c++20" npm install -g https://github.com/Auriora/agent-workbench/releases/download/v0.5.1/auriora-agent-workbench-0.5.1.tgz
```
